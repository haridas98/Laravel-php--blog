    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <img src="{{'/'.$post->author->avatar}}" alt="" vertical-align=middle border-radius="50%" width="75" height="75" >
                ...
                <div class="row"><!--blog next previous-->
                    <div class="col-md-6">
                        <div class="single-blog-box">
                            ...
                            <img src="{{'/'.$post->getPrevious()->image}}" alt="">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="{{route('post.show', $post->getNext()->slug)}}">
                                <img src="{{ '/'.$post->getNext()->image }}" alt="">
                ...
                <div class="bottom-comment"><!--bottom comment-->
                    ...
                    <img class="img-circle" src="{{'/'.$comment->author->avatar}}" alt="" width="75" height="75">
                    </div>
